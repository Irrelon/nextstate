...
exports.useProps = exports.StateController = void 0;
...
var useProps = function useProps(stateControllerMap, ComponentToWrap) {
  return (
    ...
    function (_React$Component) {
      _inherits(LightStateHOC, _React$Component);

      _createClass(LightStateHOC, null, [{
        key: "getInitialProps",
        value: function getInitialProps(ctx) {
          if (ComponentToWrap.getInitialProps) {
            return ComponentToWrap.getInitialProps(ctx).then(function (dataProps) {
              var stateData = mapToStateData(stateControllerMap);
              return _objectSpread({}, dataProps, stateData);
            });
          } else {
      ...
      function LightStateHOC(props) {
        var _this;

        _classCallCheck(this, LightStateHOC);

        _this = _possibleConstructorReturn(this, (LightStateHOC.__proto__ || Object.getPrototypeOf(LightStateHOC)).call(this, props));
        var stateData = mapToStateData(stateControllerMap, props);
        _this._changeHandlers = {};
        _this.state = _objectSpread({}, stateData);
        return _this;
      }

      _createClass(LightStateHOC, [{
