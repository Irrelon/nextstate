  ...
  function (_React$PureComponent) {
    ...
    _createClass(IrrelonNextStateHOC, [{
      ...
      value: function componentWillUnmount() {
        ...
        Object.keys(stateControllerMap).forEach(function (key) {
          var changeHandlers = _this3._changeHandlers[key];
          stateControllerMap[key].debugLog("(componentWillUnmount) Unhooking state change event for prop \"".concat(key, "\" (").concat(changeHandlers.length, " hooks found)"));
